...
import io.github.minwookShin.myAndroidBaseTemplate.databinding.DialogVerticalBinding
import org.jetbrains.anko.longToast


class VerticalDialog(context:Context) : Dialog(context), View.OnClickListener{
    private var bind :DialogVerticalBinding = DataBindingUtil.inflate(LayoutInflater.from(App.INSTANCE.applicationContext), R.layout.dialog_vertical,null,false)
    ...
    class Builder(context: Context){
        private val dialog = VerticalDialog(context)
